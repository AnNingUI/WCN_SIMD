...
interface WasmExports extends WebAssembly.Exports {
	...
	wcn_simd_add_array_f32(a: number, b: number, dst: number, len: number): void;
	/* Vector multiplication: c[i] = a[i] * b[i] */
	wcn_simd_mul_array_f32(a: number, b: number, dst: number, len: number): void;
	...
	wcn_simd_dot_product_kahan_f32(a: number, b: number, len: number): number;
...
type WCN_SIMD = {
	...
	dotProductKahanF32: WasmExports["wcn_simd_dot_product_kahan_f32"];
...
> {
	...
	return {
		...
		dotProductKahanF32: _exports.wcn_simd_dot_product_kahan_f32,
